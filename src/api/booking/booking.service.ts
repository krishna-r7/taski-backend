...
import Seat from "../event/seat.model";
import Booking from "./booking.model";
import WalletTransaction from "../wallet/walletTrans.model";
...
class BookingService {
  ...
  async getNextBookingId(session: any) {
  ...
  async getBookingsHistory(userId: string, req: any) {
  ...
  async getAllUserBookings(req: any) {
